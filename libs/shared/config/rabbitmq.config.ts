...
export const RABBITMQ_ROUTING_KEYS = {
  ...
  // Organization events
  ORGANIZATION_ORG_CREATED: 'organization.organization.created',
  ORGANIZATION_ORG_UPDATED: 'organization.organization.updated',
  ORGANIZATION_ORG_DELETED: 'organization.organization.deleted',
  ...
  ORGANIZATION_RELATION_CREATED: 'organization.relation.created',
  ORGANIZATION_RELATION_UPDATED: 'organization.relation.updated',
