...
export const AUTH_INSUFFICIENT_PERMISSIONS = 'AUTH_0010';
export const AUTH_FORBIDDEN_CROSS_TENANT = 'AUTH_0011';
export const AUTH_RESET_TOKEN_INVALID = 'AUTH_0012';
export const AUTH_RESET_TOKEN_EXPIRED = 'AUTH_0013';
export const AUTH_RESET_RATE_LIMIT = 'AUTH_0014';
export const AUTH_REFRESH_TOKEN_INVALID = 'AUTH_0015';
export const AUTH_REFRESH_TOKEN_EXPIRED = 'AUTH_0016';
export const AUTH_REFRESH_TOKEN_REVOKED = 'AUTH_0017';
export const AUTH_REFRESH_TOKEN_REUSED = 'AUTH_0018';
